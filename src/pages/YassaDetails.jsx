...
const yassaTypes = [
  {
    ...
    highlights: ['朱赤の五重布団', '播州秋祭りの基本スタイル', '魔除けと太陽の象徴'],
    color: '#e63946',
    colorLight: '#ff6b7a',
    image: soneRedImg,
  },
  {
    ...
    highlights: ['深青の五重布団', '金糸刺繍との美しい対比', '高貴で優美な存在感'],
    color: '#457b9d',
    colorLight: '#6aafd6',
    image: soneBlueImg,
  },
  {
    ...
    highlights: ['純白の五重布団', '白木と完璧に調和する美', '神聖さと清浄の象徴'],
    color: '#f8f9fa',
    colorLight: '#ffffff',
    image: soneWhiteImg,
  },
  {
    id: 'umei-mikoshi',
    title: '梅井地区の「電飾布団屋台」',
    subtitle: '夜の宮入りを彩る、幻想的な光の芸術',
    description:
      '曽根天満宮秋祭りのハイライトの一つである「夜の宮入り」で本領を発揮する布団屋台です。梅井地区をはじめとする各屋台が、夕闇の訪れとともに数百個の提灯や美しく輝く電飾に彩られます。夜空に浮かび上がる光の城のように神社の境内を激しく躍動する姿は、まさに幻想的な光の芸術です。',
    highlights: ['数多くの提灯とLED電飾', '幻想的な夜間運行', '梅井地区伝統の勇壮な練り'],
    color: '#d6a800',
    colorLight: '#ffda7b',
    image: umeiMikosiImg,
  },
